...
fillNeighborhoodsHTML = (neighborhoods = self.neighborhoods) => {
  ...
  neighborhoods.forEach(neighborhood => {
    ...
    option.setAttribute('role', 'option'); // add the role of option to the option elements
...
createRestaurantHTML = (restaurant) => {
  ...
  more.setAttribute('aria-label', 'View Details');  //add aria label to the buttons
  li.append(more)
